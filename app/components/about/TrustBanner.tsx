...
const COMMUNITY_LOGOS = [
  { src: "/images/community/coolumbowls.png", alt: "Coolum Beach Bowls Club", width: 160, height: 56 },
  { src: "/images/community/coolumfc.png", alt: "Coolum Football Club", width: 70, height: 70 },
  { src: "/images/community/peregianbeachslsc.png", alt: "Peregian Beach Surf Life Saving Club", width: 70, height: 70 },
  { src: "/images/community/ruok.png", alt: "R U OK?", width: 140, height: 56 },
];

const BRAND_LOGOS = [
  { src: "/images/associations/haymes.svg", alt: "Haymes Paint", width: 80, height: 36 },
  { src: "/images/associations/dulux.png", alt: "Dulux", width: 80, height: 36 },
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.right}>
        <h3 className={styles.rightHeading}>Backed by the best.</h3>
