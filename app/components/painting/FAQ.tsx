          ...
          <div className={styles.left}>
            <div className={styles.leftTop}>
              ...
              <p className={styles.lede}>
                Couldn't find what you're after? Our painting lead will be on
                the phone within an hour during business days.
              </p>
            </div>
            <div className={styles.contact}>
              <div className={styles.avatar}>
                <Image
                  ...
                  alt="Hylton Denton — Painting Lead"
                  fill
                  style={{ objectFit: "cover", objectPosition: "top" }}
                />
              </div>
              <p className={styles.contactHeading}>
                Talk to our painting lead.
              </p>
              <p className={styles.contactBody}>
                Hylton's been on the tools and in the office. He'll give you a
                straight answer.
              </p>
              <Button
                as="link"
